        ...
        <div class="w-full max-w-sm">
            <div class="flex flex-col break-words bg-white border-2 shadow-md mt-20">
                ...
                <form class="py-10 px-5" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="flex flex-wrap mb-6">
                        <input class="mr-1 mt-1" type="checkbox" name="remember" id="remember"
                            {{ old('remember') ? 'checked' : '' }}>

                        <label class="block text-gray-700 text-sm my-1" for="remember">
                            {{ __('Remember Me') }}
                        </label>
                    </div>
                    ...
                    <div class="flex flex-wrap">
                        <button type="submit"
                                class="bg-teal-300 hover:bg-teal-700 shadow-md
                        ...
                        <a class="text-sm text-gray-500 hover:text-gray-800 mt-5 text-center w-full" href="{{ route('password.request') }}">
